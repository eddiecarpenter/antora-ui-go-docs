= Go-Docs Antora UI Theme
// Settings:
:experimental:
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/eddiecarpenter/antora-ui-go-docs
:url-preview: https://docs.go.co.nz
...
This project generates the UI bundle for the Go-Docs {url-antora}[Antora] documentation site.
