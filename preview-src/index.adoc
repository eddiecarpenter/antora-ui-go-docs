...
[.float-group]
--
image:icon-standards.svg[Community love,180,135,float=right,role=float-gap]
...
image::icon-standards.svg[Lovely people,3000,opts=interactive]
